...
let ans1: string = "A. A superset of JavaScript that adds static typing";
let ans2 : string = "B. A special type that defines a set of named constants";
let ans3: string = "C. export function myFunction() { }";
let ans4: string = "A. A type that can hold one of several types";
let ans5: string = "A. function identity<T>(arg: T): T { return arg; }";
let ans6: string = "A. class MyClass implements MyInterface { }";
let ans7: string = "A. let num: number = 5;";
let ans8: string = "A. To define a blueprint for classes";
let ans9: string = `"A. let someValue: any = "this is a string"; let strLength: number = (<string>someValue).length;"`;
let ans10: string = "A. tsc";
